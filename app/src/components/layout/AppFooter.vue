      ...
      <div class="footer__inner">
        ...
        <ul class="nav-menu">
          <li class="nav-menu__item">
            <a href="#" class="nav-menu__link">Каталог</a>
          </li>
          <li class="nav-menu__item">
          ...
          <li class="nav-menu__item">
            <a href="#" class="nav-menu__link">О компании</a>
          </li>
        </ul>
        <div class="contacts">
          <a href="tel:+78125555555" class="contacts__item">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <a href="geo:55.43,37.64?q=Санкт-Петербург+Ефимова+3" class="contacts__item">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
...
<style lang="scss" src="@/styles/components/_footer.scss" scoped></style>
